# -*- encoding: utf-8 -*-
# stub: danger-checkstyle_format 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "danger-checkstyle_format".freeze
  s.version = "0.1.1"
  ...
  s.date = "2017-12-25"
  s.description = "Danger plugin for checkstyle formatted xml file.".freeze
  s.email = ["ishikura.noboru@gmail.com".freeze]
  s.homepage = "https://github.com/noboru-i/danger-checkstyle_format".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.7.7".freeze
  s.summary = "Danger plugin for checkstyle formatted xml file.".freeze
